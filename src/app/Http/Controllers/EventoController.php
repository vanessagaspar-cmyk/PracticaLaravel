...
class EventoController extends Controller
{
    ...
    {
        //return response()->json(['debug' => 'Llegué al controlador'], 200);
    ...
    public function show($id)
    {
        ...
        //Si el evento no se pudo recuperar, retorna mensaje de error
        if (!$evento){
            $respuesta = [
